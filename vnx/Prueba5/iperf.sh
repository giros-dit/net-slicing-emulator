echo "Setting test5 slicing configuration"
sudo lxc-attach -n PE1 -- sudo ./root/Prueba5/slices_conf_equal.sh
...
sudo lxc-attach -n PE1 -- sudo tc qdisc del dev ifb0 root
sudo lxc-attach -n PE1 -- sudo ./root/Prueba5/slices_conf_test5.sh
...
echo "Restart PEs and Ps configuration"
sudo lxc-attach -n PE1 -- sudo tc qdisc del dev ifb0 root
