echo "Setting slices test4 configuration"
sudo lxc-attach -n PE1 -- sudo ./root/Prueba4/slices_conf.sh
...
sudo lxc-attach -n PE1 -- sudo ./root/Prueba4/slices_conf_test4.sh
