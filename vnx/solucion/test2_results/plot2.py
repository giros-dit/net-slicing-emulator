...
ax1.plot(latency1_data, label='Video h1', color='#610B0B')
ax1.plot(be1_data, label='BE Traffic h4', color='#F5A9BC', alpha=0.6)
ax1.plot(embb1_data, label='eMBB Traffic', color='orange', alpha=0.9)
ax1.plot(telemetry1_data, label='Telemetry Traffic (RD)', color='#BEF781', alpha=0.6)
ax1.plot(urllc1_data, label='URLLC Traffic h5', color='#0040FF')
ax1.set_xlabel('t (s)')
...
ax2.plot(latency2_data, label='Video h1', color='#610B0B')
ax2.plot(be2_data, label='BE Traffic h4', color='#F5A9BC', alpha=0.6)
ax2.plot(embb2_data, label='eMBB Traffic', color='orange', alpha=0.9)
ax2.plot(telemetry2_data, label='Telemetry Traffic (RD)', color='#BEF781', alpha=0.6)
ax2.plot(urllc2_data, label='URLLC Traffic h5', color='#0040FF')
ax2.set_xlabel('t (s)')
...
ax3.plot(video_bw, label='Video h1', color='#DF0101')
ax3.plot(be_bw, label='BE Traffic h4', color='#F5A9BC', alpha=0.6)
ax3.plot(embb_bw, label='eMBB Traffic', color='orange', alpha=0.9)
ax3.plot(telemetry_bw, label='Telemetry Traffic (RD)', color='#BEF781', alpha=0.6)
ax3.plot(urllc_bw, label='URLLC Traffic h5', color='#0040FF')
