...
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.2 classid 1:20
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.3 classid 1:20
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.4 classid 1:21
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.5 classid 1:21
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.6 classid 1:30
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.7 classid 1:30
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.8 classid 1:4
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.9 classid 1:4
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.10 classid 1:31
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.1.11 classid 1:31
tc filter add dev ifb0 protocol ip parent 1:0 prio 7 u32 match ip src 0/0 action drop

tc filter add dev eth2 protocol ip parent 1:0 prio 0 u32 match ip src 10.0.1.0/24 classid 1:1
...
tc filter add dev eth2 protocol ip parent 2:0 prio 3 u32 match ip src 10.0.1.0/24 classid 2:2
...
tc filter add dev eth2 protocol ip parent 20:0 prio 6 u32 match ip src 10.0.1.0/24 classid 20:3
