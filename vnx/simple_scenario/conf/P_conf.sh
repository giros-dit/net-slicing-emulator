...
tc filter add dev eth2 protocol ip parent 20:0 prio 5 u32 match ip src 10.0.0.10 classid 20:3
tc filter add dev eth2 protocol ip parent 20:0 prio 5 u32 match ip src 10.0.0.11 classid 20:3
