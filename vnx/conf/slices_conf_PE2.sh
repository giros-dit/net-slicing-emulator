...
tc class add dev ifb0 parent 1:1 classid 1:3 htb rate 30mbit ceil 100mbit prio 5
tc class add dev ifb0 parent 1:1 classid 1:4 htb rate 20mbit ceil 20mbit prio 0
...
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip dst 10.0.0.2 classid 1:10
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip dst 10.0.0.6 classid 1:4
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip dst 10.0.0.3 classid 1:11
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 match ip dst 10.0.0.4 classid 1:3


echo "Creating PRIO queues"
tc qdisc add dev eth2 root handle 1: prio #Creates automatically classes 1:1, 1:2, 1:3
...
tc filter add dev eth2 protocol ip parent 1:0 prio 5 u32 match ip src 10.0.0.0/24 classid 1:3
