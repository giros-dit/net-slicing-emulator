...
tc class add dev ifb0 parent 1:2 classid 1:21 htb rate 4mbit 
tc class add dev ifb0 parent 1:1 classid 1:3 htb rate 52.8mbit ceil 100mbit
tc class add dev ifb0 parent 1:3 classid 1:30 htb rate 52.8mbit
tc class add dev ifb0 parent 1:3 classid 1:31 htb rate 10kbit ceil 10000mbit
tc class add dev ifb0 parent 1:1 classid 1:4 htb rate 1.2mbit ceil 100mbit
...
tc class add dev enp4s0 parent 10: classid 10:2 drr quantum 10766
...
tc filter add dev ifb0 protocol ip parent 1:0 prio 1 u32 \
    ...
    police rate 1.2mbit burst 1539b continue classid 1:4
...
tc filter add dev ifb0 protocol ip parent 1:0 prio 4 u32 \
    ...
    police rate 98.8mbit burst 1539b ok \
    classid 1:4
