...
tc class add dev ifb0 parent 1:2 classid 1:10 htb rate 8bit ceil 60mbit prio 1 quantum 200000
tc class add dev ifb0 parent 1:2 classid 1:11 htb rate 8bit ceil 60mbit prio 1 quantum 100000
tc class add dev ifb0 parent 1:2 classid 1:12 htb rate 10mbit ceil 60mbit prio 5 quantum 200000
