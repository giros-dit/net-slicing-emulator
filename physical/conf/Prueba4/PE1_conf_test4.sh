...
tc class add dev ifb0 parent 1:1 classid 1:2 htb rate 50mbit ceil 50mbit
tc class add dev ifb0 parent 1:1 classid 1:3 htb rate 30mbit ceil 100mbit prio 5
tc class add dev ifb0 parent 1:1 classid 1:4 htb rate 50mbit ceil 50mbit prio 0
tc class add dev ifb0 parent 1:2 classid 1:10 htb rate 50mbit ceil 50mbit prio 1
