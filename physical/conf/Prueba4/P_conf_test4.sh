...
tc filter add dev enxd46e0e069255 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.0.2 classid 1:1
tc filter add dev enxd46e0e069255 protocol ip parent 1:0 prio 1 u32 match ip src 10.0.0.6 classid 1:1
tc filter add dev enxd46e0e069255 protocol ip parent 1:0 prio 5 u32 match ip src 10.0.0.0/24 classid 1:2

tc filter add dev enxd46e0e08bca7 protocol ip parent 1:0 prio 1 u32 match ip dst 10.0.0.2 classid 1:1
tc filter add dev enxd46e0e08bca7 protocol ip parent 1:0 prio 1 u32 match ip dst 10.0.0.6 classid 1:1
tc filter add dev enxd46e0e08bca7 protocol ip parent 1:0 prio 5 u32 match ip dst 10.0.0.0/24 classid 1:2
