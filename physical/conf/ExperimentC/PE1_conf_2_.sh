...
tc class add dev ifb0 parent 1:2 classid 1:20 htb rate 32mbit ceil 100mbit burst 50k cburst 50k quantum 2000
tc class add dev ifb0 parent 1:2 classid 1:21 htb rate 4mbit ceil 100mbit burst 50k cburst 50k quantum 2000
tc class add dev ifb0 parent 1:1 classid 1:3 htb rate 52.8mbit ceil 100mbit
tc class add dev ifb0 parent 1:3 classid 1:30 htb rate 52.8mbit ceil 100mbit burst 50k cburst 50k quantum 2000 
tc class add dev ifb0 parent 1:3 classid 1:31 htb rate 10kbit ceil 10000mbit quantum 2000
tc class add dev ifb0 parent 1:1 classid 1:4 htb rate 1.2mbit ceil 100mbit burst 50k cburst 50k quantum 2000
