...
ax2.plot(vector1, telemetry2_data, label='Telemetry Traffic (RD)', color='#BEF781', marker='D', linestyle='-.', markersize=size, alpha=0.7)
ax2.plot(vector1, urllc2_data, label='URLLC Traffic', color='#0040FF', marker='o', linestyle='-', markersize=size)
ax2.set_xlabel('t (s)')
