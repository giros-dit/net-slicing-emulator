...
latency_files = [f"files/latency_metrics{i}" for i in range(1, 5)]
latency_burst_files = [f"files/latency_metrics{i}_burst_with_zeros" for i in range(1, 5)]
latency_avg_output_files = [f"files/lat_metrics{i}" for i in range(1, 5)]

bandwidth_files = [f"files/bandwidth_metrics{i}" for i in range(1, 5)]
bandwidth_burst_files = [f"files/bandwidth_metrics{i}_burst_with_zeros" for i in range(1, 5)]
bandwidth_output_files = [f"files/bw_metrics{i}" for i in range(1, 5)]

latency_max_files = [f"files/latency_max_metrics{i}" for i in range(1, 5)]
latency_max_burst_files = [f"files/latency_max_metrics{i}_burst_with_zeros" for i in range(1, 5)]
latency_max_output_files = [f"files/lat_max_metrics{i}" for i in range(1, 5)]
