...
ax2.plot(vector1, telemetry2_data, label='ToD: Telemetry', color='#BEF781', marker='D', linestyle='-.', markersize=size, alpha=0.7)
...
#ax2.legend()
tikzplotlib.save("max_lat.tex", axis_width="\\textwidth", axis_height="0.6\\textwidth")
...
ax6.set_xlim(0,60)
ax6.grid(True)
ax6.set_yticks(np.arange(0, 105 + 5, 20))
#ax6.legend()
...
fig_legend1.legend(handles, labels, loc='center', ncol=5)
plt.axis('off')
tikzplotlib.save("legend_5g_reduced.tex")
