...
sudo lxc-attach -n h4 -- iperf -c server4 -i 1 -u -b 20M -t 120 &
sleep 20

echo "Initiating Vídeo traffic"
sudo lxc-attach -n h1 -- iperf -c server1 -i 1 -u -b 40M -t 40 &
sleep 20

echo "Initiating Telemetry, eMBB and URLLC traffic"
sudo lxc-attach -n h2 -- iperf -c server2 -i 1 -u -b 40M -t 40 &
sudo lxc-attach -n h5 -- iperf -c server5 -i 1 -u -b 40M -t 40 &
sudo lxc-attach -n h3 -- iperf -c server3 -i 1 -u -b 20M -t 60 &
sleep 80
