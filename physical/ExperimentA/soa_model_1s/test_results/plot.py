...
ax2.plot(vector1, video2_data, label='ToD: Video', color='#610B0B', marker='*', linestyle='-.', markersize=size)
ax2.plot(vector1, telemetry2_data, label='ToD: Telemetry', color='#BEF781', marker='D', linestyle='-.', markersize=size)
...
tikzplotlib.save("maximum_latency_behaviour.tex", axis_width="\\textwidth", axis_height="0.8\\textwidth")
...
tikzplotlib.save("bandwidth_behaviour.tex", axis_width="\\textwidth", axis_height="0.8\\textwidth")
...
ax4.plot(pktloss_tna, label='High Priority Queue', color='#0040FF', marker='o', linestyle='-', markersize=size)
ax4.plot(pktloss_tnc, label='Low Priority Queue', color='#610B0B', marker='*', linestyle='-.', markersize=size)
ax4.set_xlabel('t (s)')
...
ax5.plot(backlog_tna, label='High Priority Queue', color='#0040FF', marker='o', linestyle='-', markersize=size)
ax5.plot(backlog_tnc, label='Low Priority Queue', color='#610B0B', marker='*', linestyle='-.', markersize=size)
ax5.set_xlabel('t (s)')
